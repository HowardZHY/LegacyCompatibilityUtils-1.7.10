...
public class ItemData {
    ...
    public static Map<String, Multiset<String>> modOrdinals = Maps.newHashMap();
    ...
    public ItemData(Item item, ModContainer mc) {
        ...
        if (item.getClass().equals(ItemBlock.class)) {
            this.itemType = Block.getBlockById(this.getItemId()).getClass().getName();
        } else {
